---
name: css-animations
description: Use when animating elements in HyperFrames compositions with CSS keyframe animations — the css runtime adapter, finite iterations, fill-mode, stagger patterns, and what to avoid
---
...
- Use finite `animation-duration` and `animation-iteration-count` — the negative-delay fallback cannot represent unbounded duration.
