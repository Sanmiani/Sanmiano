---
name: animejs
description: Use when animating elements in HyperFrames compositions with Anime.js — window.__hfAnime registry, autoplay:false contract, timeline pattern, and seek-driven rules
---
