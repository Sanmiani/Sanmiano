---
name: three
description: Use when adding Three.js 3D scenes to HyperFrames compositions — hf-seek event, window.__hfThreeTime, AnimationMixer pattern, and deterministic rendering rules
---
